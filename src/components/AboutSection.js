...
const AboutSection = () => {
    return(
        <StyledAbout>
            <Description>
                <motion.div variants={titleAnim} initial="hidden" animate="show" className="title">
                    <Hide>
                        <h2>We work to make</h2>
                    </Hide>
                    <Hide>
                        <h2>your <span>dreams</span> comes</h2>
                    </Hide>
                    <Hide>
                        <h2>true.</h2>
                    </Hide>
            ...
            <StyledImage variants={photoAnim}><img src={home1} alt="guy with a camera"/> </StyledImage>
        </StyledAbout>
    )
};
